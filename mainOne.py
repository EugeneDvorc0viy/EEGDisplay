...
class Ui_WindowCreate(object):
    def setupUi(self, WindowCreate):
        ...
        self.widgetFirst.addWidget(self.comboBox)
        self.line_2 = QtWidgets.QFrame(self.verticalLayoutWidget)
        self.line_2.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.widgetFirst.addWidget(self.line_2)
        self.line = QtWidgets.QFrame(self.verticalLayoutWidget)
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.widgetFirst.addWidget(self.line)
        ...
        self.btnDel = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        self.btnDel.setObjectName("btnDel")
        self.widgetSecond.addWidget(self.btnDel)
    ...
    def retranslateUi(self, WindowCreate):
        ...
        self.label.setText(_translate("WindowCreate", "Выберите нужную программу."))
